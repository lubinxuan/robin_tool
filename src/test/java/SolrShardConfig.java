import me.robin.solr.shard.ShardReader;
...
public class SolrShardConfig {
    public static void main(String[] args) throws InterruptedException, UnsupportedEncodingException, KeeperException {
        ShardReader shardReader = new ShardReader("172.16.2.30:3181,172.16.2.31:3181,172.16.2.32:3181");
        ...
        ShardReader.ShardRouter shardRouter = new ShardReader.ShardRouter(shardReader, "admonitor");
